...
func get_exact_cell_direction(cell:Vector2) -> Vector2:
	return flow_field_module.get_exact_cell_direction(cell)

func get_process_number_of_cell(cell:Vector2) -> Vector2:
	return flow_field_module.get_process_number_of_cell(cell)
